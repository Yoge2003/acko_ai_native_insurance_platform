"""
Car Quotation Preprocessor.
Implements the approved preprocessing strategy for the car quotation dataset.
"""
...
class CarQuotationPreprocessor(BasePreprocessor):
    """
    Preprocessor for the Car Quotation dataset.
    """
    ...
    def __init__(self):
        """
        Initializes CarQuotationPreprocessor.
        """
        super().__init__(self.REQUIRED_COLS)

    def preprocess(self, df: pd.DataFrame) -> pd.DataFrame:
        """
        Applies end-to-end preprocessing strategy for the Car Quotation dataset.
        ...
        """
        logger.info("Initializing preprocessing for Car Quotation.")
        ...
        if "previous_insurer" in df_clean.columns:
            df_clean["previous_insurer"] = df_clean["previous_insurer"].fillna("New/Unknown")
        ...
        logger.info("Car Quotation preprocessing complete. Preprocessed shape: %s", df_clean.shape)
        return df_clean
